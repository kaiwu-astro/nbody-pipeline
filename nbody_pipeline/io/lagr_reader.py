...
class LagrFileProcessor(ContinousFileProcessor):
    ...
    def read_file(self, simu_name: str) -> pd.DataFrame:
        from nbody_pipeline.io.text_parsers import read_lagr_7, l7df_to_physical_units
    ...
    def load_sns_friendly_data(self, simu_name: str) -> pd.DataFrame:
        from nbody_pipeline.io.text_parsers import transform_l7df_to_sns_friendly
